...
String key1 = "5918273678965441";
String key2 = "5623794574125630";
String key3 = "6523147066523014";
String tdes = cipher.encrypt(cipher.decrypt(cipher.encrypt(text, key1), key2), key3);
System.out.println(tdes);
String tdest = cipher.decrypt(cipher.encrypt(cipher.decrypt(tdes, key3), key2), key1);
